...
include("mumps_solve.jl")
include("solver_mumps.jl")

# Configuration
N = 15_000
sparsity_levels = [1e-6, 1e-5, 1e-4]
...
solvers = OrderedDict(
    ...
    "SLUIR, 5 iters" => (A, b) -> proposed_fn(A, b, iters = 5),
    "MUMPS base" => (A, b) -> mumps_lu_solve_fast(A, b)
)
...
plot_name = "error_vs_time_mumps.pdf"
savefig(p, plot_name)
